...
Route::middleware(['auth:sanctum', 'idAdminSuper'])->group ( function () {
    Route::get('/checkingauthsuperadmin', function () {
        return response()->json(['message' => 'your in' , 'status'=>200], 200);
    });
    
    Route::get('super-admin/allslug', [SlugController::class, 'index']);
    Route::post('super-admin/addslug', [SlugController::class, 'store']);
    Route::get('super-admin/getOneSlug/{id}', [SlugController::class, 'get']);
    Route::put('super-admin/updateSlug/{id}', [SlugController::class, 'update']);
    Route::delet('super-admin/deleteSlug/{id}', [SlugController::class, 'destroy']);

    // category
    Route::get('super-admin/getCategoryBySlug/{id}', [Categorycontoller::class, 'getbyslug']);
    Route::post('super-admin/addCategory', [Categorycontoller::class, 'store']);
    Route::get('super-admin/getOneCategory/{id}', [Categorycontoller::class, 'edit']);
    Route::put('super-admin/updateCategory/{id}', [Categorycontoller::class, 'update']);
    Route::delete('super-admin/deleteCategory/{id}', [Categorycontoller::class, 'destroy']);
    

});
Route::middleware(['auth:sanctum', 'isApiAdmin'])->group ( function () {
    Route::get('/checkingauthadmin', function () {
        return response()->json(['message' => 'your in' , 'status'=>200], 200);
    });
    //category
